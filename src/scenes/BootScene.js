...
class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('bg-beach', 'assets/bg-beach.png');
    this.load.image('bg-desert', 'assets/bg-desert.png');
    this.load.image('bg-snow', 'assets/bg-snow.png');
    this.load.image('bg-flowers', 'assets/bg-flowers.png');
    this.load.image('bg-town', 'assets/bg-town.png');
    this.load.image('bg-aurora', 'assets/bg-aurora.png');
    this.load.image('bg-ending', 'assets/bg-ending.png');
